...
-- picker. "RedBook" must stay byte-identical to the Theme.Hex series tokens above so the
...
Theme.PresetOrder = { "RedBook", "High contrast", "Colour-blind safe", "Muted" }

local DEFAULT_PRESET = "RedBook"
