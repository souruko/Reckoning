...
BUILDERS["buffs"] = function(window)
	...
	-- dropped -- the list is editable from /basil buffs too, so it can grow past what fits here.
	local chips = {}
	...
	page.Repaint = function()
		...
		if total == 0 then
			overflowLabel:SetText("Nothing ignored. /basil buffs list shows what is being tracked.")
		elseif total > shown then
			overflowLabel:SetText("+" .. (total - shown) .. " more -- see /basil buffs list")
		else
