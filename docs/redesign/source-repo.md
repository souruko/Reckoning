...
| Screen | Built from |
| --- | --- |
| `Reckoning Analyzer.dc.html` — `0a` analysis (current) | `UI/Analysis.lua`, `UI/AnalysisGraph.lua`, `UI/Frame.lua`, `UI/Row.lua`, `UI/Bar.lua`, `Constants.lua` |
| `Reckoning Analyzer.dc.html` — `0b` live meter | `UI/LiveMeter.lua`, `UI/Frame.lua`, `Constants.lua` |
| `Reckoning Analyzer.dc.html` — `0c` death cause | `UI/DeathCause.lua`, `UI/Row.lua`, `UI/Bar.lua`, `Constants.lua` |
| `Reckoning Analyzer.dc.html` — `1a` analysis (redesign) | `UI/Analysis.lua`, `UI/AnalysisGraph.lua`, `Session.lua`, `docs/DESIGN.md` |
| `Reckoning Analyzer.dc.html` — `1b`/`1c` meter + death redesign | `UI/LiveMeter.lua`, `UI/DeathCause.lua` |
