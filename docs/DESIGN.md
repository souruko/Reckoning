# Basil — combat analyser for LOTRO
...
`/basil options`, and the **Open options** button on the Plugin Manager stub. 560 × 452: a 146px
...
Follow the `VitalSelf` pattern: `Turbine.PluginData.Save(Turbine.DataScope.Character, "Basil", settings)`.
